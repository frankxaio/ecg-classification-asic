...
dataWidth = 16 # Total bit width for weights and biases
dataIntWidth = 1 # Number of integer bits for data
weightIntWidth = 4 # # Number of integer bits for weights
inputFile = "WeigntsAndBiases.txt"
dataFracWidth = dataWidth-dataIntWidth
weightFracWidth = dataWidth-weightIntWidth
biasIntWidth = dataIntWidth+weightIntWidth # Number of integer bits for bias
